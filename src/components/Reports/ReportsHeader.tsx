    ...
    <div className="bg-gradient-to-r from-slate-900 via-purple-900 to-slate-900 border-b border-purple-500/20 shadow-2xl px-6 py-4">
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <h1 className="text-2xl font-bold text-white">{reportType}</h1>
        </div>
      ...
      {/* Filters Bar */}
      <div className="flex items-center space-x-4 mt-4 py-2 border-t border-slate-700">
        <span className="text-sm text-gray-300">Created: Last 24 hours</span>
        <Button
          variant="secondary"
          icon={SquarePen}
          onClick={onEdit}
